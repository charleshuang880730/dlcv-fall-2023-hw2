...
target_set = Dataset(csv_file="../hw2_data/digits/usps/train.csv", img_folder="../hw2_data/digits/usps/data", image_size=(28, 28))
target_loader = DataLoader(target_set, batch_size=batch_size, shuffle=True, num_workers=6, drop_last=True)
target_loader = iter(cycle(target_loader))
# Validation set from target domain
target_valid_set = Dataset(csv_file="../hw2_data/digits/usps/val.csv", img_folder="../hw2_data/digits/usps/data", image_size=(28, 28))
...
for epoch in range(n_epochs):
    ...
    data_target_iter = iter(cycle(target_loader))"""
    ...
    for (source_data, source_label), (target_data, _) in tqdm(zip(source_loader, target_loader), total=len(source_loader)):
        ...
        """print("target domain output shape:")
        print(domain_output.shape)
        print("target domain label shape:")
        ...
        """print("source domain output shape:")
        print(domain_output.shape)
        print("source domain label shape:")
        print(source_domain_label.shape)"""
